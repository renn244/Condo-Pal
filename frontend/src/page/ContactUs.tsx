...
const ContactUs = () => {
    ...
    const onSubmit = async (data: z.infer<typeof formSchema>) => {
        setIsLoading(true)
        try {
            const response = await axiosFetch.post("/contact", data)
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2">
                    <div className="lg:mb-0 mb-10">
                        <div className="group w-full h-full">
                            ...
                            <img src="https://pagedone.io/asset/uploads/1696488602.png" alt="ContactUs tailwind section" className="w-full h-full lg:rounded-l-2xl lg:rounded-r-none rounded-2xl bg-blend-multiply bg-indigo-700 object-cover"/>
                    ...
                    <div className="bg-gray-50 p-5 lg:p-8 lg:rounded-r-2xl lg:rounded-l-none rounded-2xl space-y-2">
                        <Form {...form}>
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-2">
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input {...field} type="text" className="w-full" placeholder="Name" />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input {...field} type="email" className="w-full" placeholder="Email" />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Textarea {...field} className="w-full min-h-[250px] max-h-[330px]" placeholder="Message" />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
