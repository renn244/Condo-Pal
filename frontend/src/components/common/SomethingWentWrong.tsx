import { AlertCircle, ChevronLeft, HomeIcon, RefreshCcw } from "lucide-react"
            ...
            <div className="container px-4 md:px-6 flex flex-col items-center text-center space-y-4">
                <div className="relative">
                    <div className="relative flex items-center justify-center">
                        <AlertCircle className="h-24 w-24 text-blue-600 animate-pulse" />
                ...
                {(import.meta.env.VITE_SOFTWARE_ENV || "") == "development" && (
                    <div className="mt-4 p-4 bg-gray-50 rounded-lg text-left w-full max-w-lg">
                        <p className="text-sm font-mono text-gray-600 break-all">
                            Unknown error occurred
                        </p>
                        <p className="text-xs text-gray-500 mt-2">Error ID: sdadaskdnaslk</p>
                    </div>
                )}
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-8">
                    ...
                    <Button className="gap-2 bg-blue-600 hover:bg-blue-700" onClick={reset}>
